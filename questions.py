[{
	"question": "When does India celebrate Independence Day?",
...
{
	"question": "What is the theme of Asia health conference 2019?",
	"options": ["A. Competitiveness of India Inc- India@60: Forging Ahead",
		"B. Competitiveness of India Inc- India@75: Forging Ahead",
		"C. Competitiveness of India Inc- India@80: Forging Ahead",
		"D. Competitiveness of India Inc- India@90: Forging Ahead"],
	"answer": "B. Competitiveness of India Inc- India@75: Forging Ahead"
},
{
...
{
	"question": "Who has won pro Kabadi League this season?",
	"options": ["A. Dabang Delhi",
		"B. Bengal Warriors",
		"C. Puneri paltan",
		"D. U Mumba"],
	"answer": "B. Bengal Warriors"
},
{
...
},
{
	...
	"options": ["A. Jatindranath Mukherjee",
		"B. Jatindranath Bannerjee",
		"C. Jatindranath Das",
		"D. Jatindranath bose"],
	"answer": "A. Jatindranath Mukherjee"
},
{
	"question": "Garampani Sanctuary is locate in which of the following places?",
	"options": ["A. Junagarh, Gujarat",
		"B. Kohima, Nagaland",
		"C. Diphu, Assam",
		"D. Gangtok, Sikkim"],
...
},
{
	...
	"options": ["A. Developed the telescope",
...
{
	"question": "Madhya Pradesh Chief Minister Kamal Nath has declared that Bhopal metro will be known as?",
	"options": ["A. Bhoj Metro",
		"B. Khoj Metro",
		"C. Bhopal Metro",
		"D. Auranga Metro"],
	"answer": "A. Bhoj Metro"
...
},
{
	...
	"options": ["A. Lord Alfred Tennyson",
...
{
	"question": "Which is the oldest football competition in India?",
	"options": ["A. Aryan Cup",
		"B. Santosh Trophy",
		"C. Durand Cup",
		"D. Federation Cup"],
